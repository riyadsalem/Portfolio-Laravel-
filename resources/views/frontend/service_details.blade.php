...
@section('title')
Service Details | RiyadMS Website
@endsection
                            ...
                            <div class="breadcrumb__wrap__content">
                                ...
                                <nav aria-label="breadcrumb">
                                    <ol class="breadcrumb">
                                        ...
                                        <li class="breadcrumb-item active" aria-current="page">{{ $service-> services_title	 }}</li>
                                    </ol>
                                </nav>
                            </div>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-lg-8">
                            <div class="services__details__thumb">
                                <img src="{{ asset($service->services_image) }}" alt="">
                            </div>
                            <div class="services__details__content">
                                <h2 class="title">{{ $service->services_title }}</h2>
                                @if($service->service_long_description)
                                <p>{!!$service->service_long_description!!}</p>
                                @endif
                                <!-- Delete .service__details__img & .small-title -->
