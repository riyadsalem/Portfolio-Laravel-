            ...
            <div class="col-xl-3 col-lg-4 col-sm-6">
                <div class="footer__widget">
                    ...
                    <div class="footer__widget__social">
                        <p>{{ Str::limit($allfooter->short_description,80) }}</p>
                        <ul class="footer__social__list">
                            <li><a target="_blank" href="{{ $allfooter->facebook }}"><i class="fab fa-facebook-f"></i></a></li>
                            <li><a target="_blank" href="{{ $allfooter->twitter }}"><i class="fab fa-twitter"></i></a></li>
                        </ul>
                    </div>
                </div>
            </div>
