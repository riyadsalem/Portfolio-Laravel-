...
<section class="portfolio">
    <div class="container">
        ...
        <!-- Delete Section .row justify-content-center -->
    </div>
                        ...
                        @foreach($protfolio as $item)
                            ...
                            <div class="portfolio__item">
                                ...
                                <div class="portfolio__overlay__content">
                                    ...
                                    <h4 class="title"><a target="_blank" href="{{ route('portfolio.details',$item->id) }}">
                                        {{ $item->portfolio_title }}
                                    </a></h4>
                                    <a target="_blank" href="{{ route('portfolio.details',$item->id) }}" class="link">Case Study</a>
                                </div>
                            </div>
